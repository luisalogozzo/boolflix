new Vue({
  ...
  data : {
    apiKey: '25046906a5edc120a00e8cdb72843203',
    slides: [],
  },
  methods: {
    Slider() {
      ...
      .then(function (response) {
        ...
        while (ResultsArray.length <= 5) {
          ThisResults = response.data.results[i];
          if (ThisResults.overview.length > 0) {
            ...
            var newSlide = {
              ...
              backdrop_path: ThisResults.backdrop_path,
              vote_average: ThisResults.vote_average,
            };
...
//     movieId = $(this).parents('.upcoming-film').data('id');
